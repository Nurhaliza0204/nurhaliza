...
<head>
    ...
    <title>@yield('title', 'Website PLN Medan Tuntungan')</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">PLN Medan Tuntungan</a>
    ...
    <footer class="bg-dark text-white text-center py-3 mt-4">
        <p>&copy; {{ date('Y') }} PLN Medan Tuntungan. All Rights Reserved.</p>
    </footer>
